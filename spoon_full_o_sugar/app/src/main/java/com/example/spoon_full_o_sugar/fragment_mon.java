...
public class fragment_mon extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.i("MON FRAG","getSched(med_sched_mon)");
        sched = DB.getSched("med_sched_mon");
        ...
        adapt = new RecycleAdapterDelete(container.getContext(), name, dose, time, icon, DB_ID, "mon", "fragment_mon");
