...
public class fragment_fri extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.i("FRI FRAG","getSched(med_sched_fri)");
        sched = DB.getSched("med_sched_fri");
        ...
        adapt = new RecycleAdapterDelete(container.getContext(), name, dose, time, icon, DB_ID, "fri", "fragment_fri");
