...
public class fragment_wed extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.i("WED FRAG","getSched(med_sched_wed)");
        sched = DB.getSched("med_sched_wed");
        ...
        adapt = new RecycleAdapterDelete(container.getContext(), name, dose, time, icon, DB_ID, "wed", "fragment_wed");
