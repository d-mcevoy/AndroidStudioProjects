...
public class fragment_thur extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.i("THUR FRAG","getSched(med_sched_thur)");
        sched = DB.getSched("med_sched_thur");
        ...
        adapt = new RecycleAdapterDelete(container.getContext(), name, dose, time, icon, DB_ID, "thur", "fragment_thur");
