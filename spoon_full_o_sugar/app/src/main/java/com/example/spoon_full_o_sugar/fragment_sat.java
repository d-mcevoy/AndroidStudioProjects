...
public class fragment_sat extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.i("SAT FRAG","getSched(med_sched_sat)");
        sched = DB.getSched("med_sched_sat");
        ...
        adapt = new RecycleAdapterDelete(container.getContext(), name, dose, time, icon, DB_ID, "sat", "fragment_sat");
