...
public class fragment_tues extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.i("TUES FRAG","getSched(med_sched_tues)");
        sched = DB.getSched("med_sched_tues");
        ...
        adapt = new RecycleAdapterDelete(container.getContext(), name, dose, time, icon, DB_ID, "tues", "fragment_tues");
